...
match scelta:
    ...
    case 4:
        ...
        # 7. index(): Trova l'indice del primo elemento che corrisponde al valore dato
        indice = lista.index(30)
        print(f"Indice di 30 nella lista: {indice} -> Troviamo l'indice del numero 30")

        # 8. count(): Conta quante volte un valore appare nella lista
        conta = lista.count(50)
        print(f"Numero di occorrenze di 50: {conta} -> Contiamo quante volte appare il numero 50 nella lista")

        # 9. len(): Restituisce il numero di elementi nella lista
        lunghezza = len(lista)
        ...
        lista.clear()
        print(f"Lista dopo clear(): {lista}  -> La lista è stata svuotata")

        # 11. extend(): Aggiunge tutti gli elementi di un'altra lista alla fine della lista
        lista = [1, 2, 3]
        lista.extend([4, 5, 6])
        print(f"Lista dopo extend([4, 5, 6]): {lista} -> Aggiungiamo gli elementi [4, 5, 6] alla lista")

        # 12. copy(): Restituisce una copia superficiale della lista
        lista_copy = lista.copy()
        print(f"Lista copia: {lista_copy}  -> Creiamo una copia della lista")

        # 13. slicing: Creiamo una sottolista (sub-list) dalla lista originale
        sottolista = lista[1:4]  # Prende gli elementi dalla posizione 1 alla 3 (escluso 4)
        print(f"Sottolista (lista[1:4]): {sottolista} -> Creiamo una sottolista che va dalla posizione 1 alla 3")
    case 5:
        print("\nTuple")
    ...
    case 6:
        ...
        # 3. discard(): Rimuovere un elemento (non solleva errore se l'elemento non esiste)
        insieme.discard(3)
        print(f"Insieme dopo discard(3): {insieme}  -> Rimuoviamo il numero 3 dall'insieme (senza errore se non esiste)")
        ...
        # 11. copy(): Crea una copia dell'insieme
        insieme_copy = insieme2.copy()
        print(f"Insieme dopo copy(): {insieme_copy}  -> Creiamo una copia di insieme2")

        # 12. intersection_update(): Intersezione dell'insieme corrente con un altro, modifica l'insieme originale
        ...
        # 13. difference_update(): Differenza dell'insieme corrente con un altro, modifica l'insieme originale
        ...
        # 14. isdisjoint(): Verifica se due insiemi non hanno elementi in comune
        ...
        # 15. issubset(): Verifica se un insieme è un sottoinsieme di un altro
        subset_check = insieme2.issubset(unione)
        print(f"Insieme2 è un sottoinsieme di unione? {subset_check}  -> Verifica se insieme2 è un sottoinsieme di unione")

        # 16. issuperset(): Verifica se un insieme è un superset di un altro
        superset_check = unione.issuperset(insieme2)
        print(f"Unione è un superset di insieme2? {superset_check}  -> Verifica se unione è un superset di insieme2")
